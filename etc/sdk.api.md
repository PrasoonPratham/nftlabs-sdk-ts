...
export class BundleDropModule
  extends ModuleWithRoles<LazyMintERC1155>
...
export class BundleModule
  extends ModuleWithRoles<NFTCollection>
  implements ITransferable
{
  // (undocumented)
...
export class DropModule
  extends ModuleWithRoles<LazyMintERC721>
  implements ITransferable
{
  // @internal
  constructor(
...
//
// @internal (undocumented)
export function getGasPriceForChain(
  chainId: number,
  speed: string,
  maxGasPrice: number
): Promise<number | null>;
...
//
// @internal
export function getMetadataWithoutContract(
  provider: ProviderOrSigner,
...
// @public (undocumented)
export function getTokenMetadataUsingStorage(
  contractAddress: string,
  provider: ProviderOrSigner,
  tokenId: string,
  storage: IStorage
...
export class MarketModule extends ModuleWithRoles<Market> {
  ...
  list(
    ...
    secondsUntilStart?: BigNumberish_2,
    secondsUntilEnd?: BigNumberish_2
  ...
  implements IMarketplace
{
  ...
  // (undocumented)
  isWinningBid(
    winningPrice: BigNumberish_2,
    newBidPrice: BigNumberish_2,
    bidBuffer: BigNumberish_2
  ): Promise<boolean>;
  makeAuctionListingBid(bid: {
    listingId: BigNumberish_2;
    pricePerToken: BigNumberish_2;
...
export class Module<TContract extends BaseContract = BaseContract> {
  ...
  // @internal (undocumented)
  protected sendContractTransaction(
    contract: BaseContract,
    fn: string,
    args: any[],
    callOverrides?: CallOverrides
...
export class ThirdwebSDK implements IThirdwebSdk {
  ...
  // (undocumented)
  setProviderOrSigner(
    providerOrSignerOrNetwork: ValidProviderInput
  ): ProviderOrSigner;
  // @internal
